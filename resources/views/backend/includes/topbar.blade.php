        ...
        <div class="d-flex align-items-center gap-1">
            ...
            <!-- <div class="app-search d-none d-lg-block">
                <form action="#">
                    ...
                    <input type="search" id="category_search" class="form-control" placeholder="Search..." autocomplete="off">
        ...
        <ul class="topbar-menu d-flex align-items-center gap-3">
            ...
            <li class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated profile-dropdown">
                    ...
                    <button data-bs-toggle="modal" data-bs-target="#changePasswordModal" class="dropdown-item cursor-pointer">
