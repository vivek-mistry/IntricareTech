                            ...
                            <div id="layout-boxed">
                                <div class="form-check form-switch card-switch mb-1">
                                    ...
                                    <label class="form-check-label" for="layout-mode-boxed">
                                        <img src="{{ asset('backend/images/layouts/boxed.png') }}" alt=""
                                            class="img-fluid">
                                    </label>
                                </div>
                    ...
                    <div class="col-4">
                        <div class="form-check form-switch card-switch mb-1">
                            ...
                            <label class="form-check-label" for="topbar-color-dark">
                                <img src="{{ asset('backend/images/layouts/topbar-dark.png') }}" alt=""
                                    class="img-fluid">
                            </label>
                        </div>
                        <h5 class="font-14 text-center text-muted mt-2">Dark</h5>
                        ...
                        <div class="col-4">
                            <div class="form-check form-switch card-switch mb-1">
                                ...
                                <label class="form-check-label" for="leftbar-color-light">
                                    <img src="{{ asset('backend/images/layouts/sidebar-light.png') }}" alt=""
                                        class="img-fluid">
                                </label>
                            </div>
                            <h5 class="font-14 text-center text-muted mt-2">Light</h5>
                        ...
                        <div class="col-4">
                            <div class="form-check form-switch card-switch mb-1">
                                ...
                                <label class="form-check-label" for="leftbar-color-dark">
                                    <img src="{{ asset('backend/images/layouts/light.png') }}" alt=""
                                        class="img-fluid">
                                </label>
                            </div>
                            <h5 class="font-14 text-center text-muted mt-2">Dark</h5>
                        ...
                        <div class="col-4">
                            <div class="form-check form-switch card-switch mb-1">
                                ...
                                <label class="form-check-label" for="leftbar-size-compact">
                                    <img src="{{ asset('backend/images/layouts/compact.png') }}" alt=""
                                        class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-4">
                            <div class="form-check form-switch card-switch mb-1">
                                ...
                                <label class="form-check-label" for="leftbar-size-full">
                                    <img src="{{ asset('backend/images/layouts/full.png') }}" alt=""
                                        class="img-fluid">
                                </label>
                            </div>
