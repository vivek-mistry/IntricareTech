<x-backend.layout>
    ...
    <x-backend.modal id="contactCreateModal" title="Add Contact" form="contactStoreForm"
        action="{{ route('contact.store') }}" method="POST" scrollable="false" size="modal-lg">
        @include('contact.form')
    </x-backend.modal>

    <x-backend.modal id="contactEditModal" title="Edit Contact" form="contactEditForm"
        action="{{ route('contact.update', ['contact' => ':id']) }}" method="POST" scrollable="false" size="modal-lg">
        @include('contact.form')
    </x-backend.modal>
